...
(function () {
  ...
  function mergeCourse(cloud, local) {
    ...
    return {
      ...
      nextLearningDay: Math.max(Number(remote.nextLearningDay) || 1, Number(device.nextLearningDay) || 1),
      highestReachedDay: Math.max(Number(remote.highestReachedDay) || 1, Number(device.highestReachedDay) || 1),
      courseCompleted: !!(remote.courseCompleted || device.courseCompleted),
